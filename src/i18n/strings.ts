...
type Strings = {
  ...
  contentEditor: {
    ...
    addLineBreak: string
    remove: string
    /** Buscar un icono por su nombre, dentro del selector. */
    search: string
    noResults: string
    custom: string
    core: string
...
const STRINGS: Record<Language, Strings> = {
  ...
  pt: {
    ...
    contentEditor: {
      ...
      remove: 'Remover',
      search: 'Buscar ícone…',
      noResults: 'Nenhum ícone corresponde',
      custom: 'Próprios',
      core: 'Dune Imperium',
  ...
  it: {
    ...
    contentEditor: {
      ...
      remove: 'Togli',
      search: 'Cerca icona…',
      noResults: 'Nessuna icona corrisponde',
  ...
  cs: {
    ...
    contentEditor: {
      ...
      remove: 'Odebrat',
      search: 'Hledat symbol…',
      noResults: 'Žádné odpovídající symboly',
      custom: 'Vlastní',
      core: 'Dune Imperium',
  ...
  ru: {
    ...
    contentEditor: {
      ...
      noResults: 'Нет подходящих символов',
      custom: 'Свои',
      core: 'Dune Imperium',
  ...
  uk: {
    ...
    contentEditor: {
      ...
      remove: 'Прибрати',
      search: 'Пошук символу…',
      noResults: 'Немає відповідних символів',
      custom: 'Власні',
      core: 'Dune Imperium',
  ...
  bg: {
    ...
    contentEditor: {
      ...
      remove: 'Премахване',
      search: 'Търсене на символ…',
      noResults: 'Няма съвпадащи символи',
      custom: 'Собствени',
      core: 'Dune Imperium',
