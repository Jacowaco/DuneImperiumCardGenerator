...
export const INFLUENCE_VARIANTS: Record<InfluenceVariant, Record<Language, string>> = {
  'gain-one': { es: 'Ganar 1', en: 'Gain 1', pt: 'Ganhar 1', fr: 'Gagner 1', de: 'Erhalte 1' },
  'lose-one': { es: 'Perder 1', en: 'Lose 1', pt: 'Perder 1', fr: 'Perdre 1', de: 'Verliere 1' },
  'gain-two': { es: 'Ganar 2', en: 'Gain 2', pt: 'Ganhar 2', fr: 'Gagner 2', de: 'Erhalte 2' },
  'lose-two': { es: 'Perder 2', en: 'Lose 2', pt: 'Perder 2', fr: 'Perdre 2', de: 'Verliere 2' },
}
